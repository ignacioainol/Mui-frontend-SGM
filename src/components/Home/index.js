...
const MyNetwork = () => {
  {
    const graph = {
      nodes: [
        ...
        {id: 1, label: "1", group: 'diamonds'},
        {id: 2, label: "2", group: 'mints'},
        {id: 3, label: "3", group: 'diamonds'},
        {id: 4, label: "4", group: 'mints'},
        {id: 5, label: "5", group: 'diamonds'},
        {id: 6, label: "6", group: 'diamonds'},
        {id: 7, label: "7", group: 'mints'},
        {id: 8, label: "8", group: 'diamonds'},
        {id: 9, label: "9", group: 'diamonds'},
        ...
        {id: 18, label: "Iron Maiden", group: 'mints'},
